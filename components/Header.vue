<template>
  <nav class="bg-blue-600 text-white py-4 shadow-md sticky top-0 z-50">
      ...
      <div class="hidden md:flex items-center space-x-8">
        ...
        >
          ...
          >
            <NuxtLink
              to="/services/pln"
              class="block px-4 py-2 hover:bg-indigo-100 rounded-md transition-all duration-300"
              @click="closeDropdown"
            >
              Gali Kabel PLN
            </NuxtLink>
    ...
    <div v-if="isMobileMenuOpen" class="md:hidden bg-blue-600 text-white shadow-lg p-4 space-y-4">
      ...
      <div>
        ...
        <div v-if="isDropdownMobileOpen" class="bg-white text-black rounded-md mt-2 p-4">
          <NuxtLink
            to="/services/pln"
            class="block hover:bg-indigo-100 px-4 py-2 rounded-md transition-all duration-300"
